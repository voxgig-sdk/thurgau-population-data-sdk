...
// instead of `sdk.NewThurgauPopulationDataSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ThurgauPopulationDataSDK  { return NewThurgauPopulationDataSDK(nil) }
func Test() *ThurgauPopulationDataSDK { return TestSDK(nil, nil) }
