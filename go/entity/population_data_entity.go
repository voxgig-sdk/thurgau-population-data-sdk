...
type PopulationDataEntity struct {
	name    string
	client  *core.ThurgauPopulationDataSDK
...
func NewPopulationDataEntity(client *core.ThurgauPopulationDataSDK, entopts map[string]any) *PopulationDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PopulationDataEntity) GetName() string { return e.name }
...
func (e *PopulationDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PopulationDataEntity) Deleted() bool {
	return e.deleted
}


func (e *PopulationDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPopulationDataEntity(e.client, opts)
}

func (e *PopulationDataEntity) Data(args ...any) any {
...
func (e *PopulationDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PopulationDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PopulationDataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *PopulationDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PopulationDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PopulationDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PopulationDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
