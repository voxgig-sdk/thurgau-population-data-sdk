...
AQL-driven CLI and REPL for the ThurgauPopulationData SDK. Positional arguments are
...
```sh
go build -o thurgau-population-data-cli ./...
```
...
./thurgau-population-data-cli load 1 population_data
./thurgau-population-data-cli load '{id:1}' population_data
