...
func registerSDKWords(r *eng.Registry, client *sdk.ThurgauPopulationDataSDK) {
...
func runOp(client *sdk.ThurgauPopulationDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
