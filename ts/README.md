...
The TypeScript SDK for the ThurgauPopulationData API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new ThurgauPopulationDataSDK({ apikey: '...' })
