...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.THURGAUPOPULATIONDATA_TEST_LIVE ||
    'TRUE' === process.env.THURGAUPOPULATIONDATA_TEST_OVERRIDE
  ) {
  ...
  m.THURGAUPOPULATIONDATA_TEST_EXPLAIN = process.env.THURGAUPOPULATIONDATA_TEST_EXPLAIN || m.THURGAUPOPULATIONDATA_TEST_EXPLAIN
