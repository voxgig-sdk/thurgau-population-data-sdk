...
function envOverride(m) {
    if ('TRUE' === process.env.THURGAU_POPULATION_DATA_TEST_LIVE ||
        'TRUE' === process.env.THURGAU_POPULATION_DATA_TEST_OVERRIDE) {
    ...
    m.THURGAU_POPULATION_DATA_TEST_EXPLAIN = process.env.THURGAU_POPULATION_DATA_TEST_EXPLAIN || m.THURGAU_POPULATION_DATA_TEST_EXPLAIN;
    return m;
}
