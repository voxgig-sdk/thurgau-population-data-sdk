...
(0, node_test_1.describe)('PopulationDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ThurgauPopulationDataSDK({
    ...
    (0, node_test_1.test)('direct-load-population_data', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-population_data', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-population_data', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-population_data', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ThurgauPopulationDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['THURGAU_POPULATION_DATA_TEST_POPULATION_DATA_ENTID'];
    ...
    const client = new __1.ThurgauPopulationDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PopulationDataDirect.test.js.map