...
// ThurgauPopulationData SDK rbac feature
...
class ThurgauPopulationDataRbacFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    private function _required(ThurgauPopulationDataContext $ctx): ?string
    {
    ...
    private function _reject(ThurgauPopulationDataContext $ctx, string $required): void
    {
    ...
    private function _track(ThurgauPopulationDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
