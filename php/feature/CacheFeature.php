...
// ThurgauPopulationData SDK cache feature
...
class ThurgauPopulationDataCacheFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    private function _through(ThurgauPopulationDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
