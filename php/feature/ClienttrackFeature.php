...
// ThurgauPopulationData SDK clienttrack feature
...
class ThurgauPopulationDataClienttrackFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    public function PostConstruct(ThurgauPopulationDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ThurgauPopulationData-SDK';
