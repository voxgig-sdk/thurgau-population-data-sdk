...
// ThurgauPopulationData SDK netsim feature
...
class ThurgauPopulationDataNetsimFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    private function _simulate(ThurgauPopulationDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ThurgauPopulationDataContext $ctx, array $applied): void
    {
        $client = $this->client;
