...
// ThurgauPopulationData SDK audit feature
...
class ThurgauPopulationDataAuditFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    private function _emit(ThurgauPopulationDataContext $ctx, string $outcome): void
    {
