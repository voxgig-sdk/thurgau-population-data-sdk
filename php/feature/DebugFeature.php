...
// ThurgauPopulationData SDK debug feature
...
class ThurgauPopulationDataDebugFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    private function _finish(ThurgauPopulationDataContext $ctx, bool $ok): void
    {
