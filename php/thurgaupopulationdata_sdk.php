...
class ThurgauPopulationDataSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ThurgauPopulationDataHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ThurgauPopulationDataHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ThurgauPopulationDataFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ThurgauPopulationDataFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ThurgauPopulationDataUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ThurgauPopulationDataHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ThurgauPopulationDataHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ThurgauPopulationDataHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ThurgauPopulationDataError($op . "_allow",
                "ThurgauPopulationDataSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ThurgauPopulationDataHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ThurgauPopulationDataError("graphql_error",
                "ThurgauPopulationDataSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function PopulationData($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_population_data === null) {
                $this->_population_data = new PopulationDataEntity($this, null);
            }
            return $this->_population_data;
        }
        return new PopulationDataEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ThurgauPopulationDataSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
