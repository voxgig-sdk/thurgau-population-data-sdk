...
// ThurgauPopulationData SDK utility type

class ThurgauPopulationDataUtility
{
    ...
    public static function copy(ThurgauPopulationDataUtility $src): ThurgauPopulationDataUtility
    {
        $u = new ThurgauPopulationDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
