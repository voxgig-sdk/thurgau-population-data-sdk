...
// ThurgauPopulationData SDK utility: fetcher

class ThurgauPopulationDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ThurgauPopulationDataSDK/1.0)';
    ...
    public static function call(ThurgauPopulationDataContext $ctx, string $fullurl, array $fetchdef): array
    {
