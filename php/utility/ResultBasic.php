...
// ThurgauPopulationData SDK utility: result_basic

class ThurgauPopulationDataResultBasic
{
    public static function call(ThurgauPopulationDataContext $ctx): ?ThurgauPopulationDataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ThurgauPopulationDataError) ? $result->err->msg : (string)$result->err;
