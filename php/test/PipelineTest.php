...
// ThurgauPopulationData SDK pipeline test
//
...
{
    private static function utility(): ThurgauPopulationDataUtility
    {
        return new ThurgauPopulationDataUtility();
    }
    ...
    private static function ctx(array $over = []): ThurgauPopulationDataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ThurgauPopulationDataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ThurgauPopulationDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ThurgauPopulationDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ThurgauPopulationDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ThurgauPopulationDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ThurgauPopulationDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ThurgauPopulationDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ThurgauPopulationDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ThurgauPopulationDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ThurgauPopulationDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ThurgauPopulationDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ThurgauPopulationDataResponse([]),
            'result' => new ThurgauPopulationDataResult([]),
        ]);
        [, $err] = ThurgauPopulationDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ThurgauPopulationDataSpec([]),
            'response' => null,
            'result' => new ThurgauPopulationDataResult([]),
        ]);
        [, $err] = ThurgauPopulationDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ThurgauPopulationDataSpec(['step' => 's']),
            'response' => new ThurgauPopulationDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ThurgauPopulationDataResult([]),
        ]);
        [, $err] = ThurgauPopulationDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ThurgauPopulationDataSpec(['step' => 's']),
            'response' => new ThurgauPopulationDataResponse(self::resp(200, ['v' => 1])),
            'result' => new ThurgauPopulationDataResult([]),
        ]);
        [, $err] = ThurgauPopulationDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ThurgauPopulationDataSpec(['step' => 's']),
            'response' => new ThurgauPopulationDataResponse(self::resp(200, ['v' => 2])),
            'result' => new ThurgauPopulationDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ThurgauPopulationDataMakeResponse::call($ctx);
    ...
    {
        $preset = new ThurgauPopulationDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ThurgauPopulationDataSpec([]),
            'response' => new ThurgauPopulationDataResponse([]),
            'result' => new ThurgauPopulationDataResult([]),
        ...
        [$got, $err] = ThurgauPopulationDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ThurgauPopulationDataResult([])]);
        [, $err] = ThurgauPopulationDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ThurgauPopulationDataSpec([]), 'result' => null]);
        [, $err] = ThurgauPopulationDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ThurgauPopulationDataSpec(['step' => 's']),
            'result' => new ThurgauPopulationDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ThurgauPopulationDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ThurgauPopulationDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ThurgauPopulationDataSpec(['step' => 's']),
            'result' => new ThurgauPopulationDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ThurgauPopulationDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ThurgauPopulationDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ThurgauPopulationDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ThurgauPopulationDataSpec([]),
            'result' => new ThurgauPopulationDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ThurgauPopulationDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ThurgauPopulationDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ThurgauPopulationDataError('boom', 'boom');
        $utility->fetcher = function (ThurgauPopulationDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ThurgauPopulationDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ThurgauPopulationDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ThurgauPopulationDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ThurgauPopulationDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ThurgauPopulationDataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ThurgauPopulationDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ThurgauPopulationDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ThurgauPopulationDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ThurgauPopulationDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ThurgauPopulationDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ThurgauPopulationDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ThurgauPopulationDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ThurgauPopulationDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ThurgauPopulationDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ThurgauPopulationDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ThurgauPopulationDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ThurgauPopulationDataResult(['ok' => false])]);
        $this->expectException(ThurgauPopulationDataError::class);
        ThurgauPopulationDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ThurgauPopulationDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ThurgauPopulationDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ThurgauPopulationDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ThurgauPopulationDataBaseFeature();
        $b = new ThurgauPopulationDataBaseFeature();
        ThurgauPopulationDataFeatureAdd::call($ctx, $a);
        ThurgauPopulationDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ThurgauPopulationDataBaseFeature
    {
        $f = new ThurgauPopulationDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ThurgauPopulationDataFeatureAdd::call($ctx, self::named_feature('a'));
        ThurgauPopulationDataFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ThurgauPopulationDataFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ThurgauPopulationDataFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ThurgauPopulationDataFeatureAdd::call($ctx, $replace);
        ...
        ThurgauPopulationDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ThurgauPopulationDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ThurgauPopulationDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ThurgauPopulationDataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ThurgauPopulationDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ThurgauPopulationDataResponse(['headers' => null]),
            'result' => new ThurgauPopulationDataResult([]),
        ]);
        ThurgauPopulationDataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ThurgauPopulationDataResultBody::call($ctx);
