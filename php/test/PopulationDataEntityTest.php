...
class PopulationDataEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $cfg = ThurgauPopulationDataConfig::shared_config();
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set THURGAU_POPULATION_DATA_TEST_POPULATION_DATA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function population_data_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("THURGAU_POPULATION_DATA_TEST_POPULATION_DATA_ENTID");
