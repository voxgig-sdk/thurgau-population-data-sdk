...
// ThurgauPopulationData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ThurgauPopulationDataSDK::test)
...
{
    private const SDK_CLASS = 'ThurgauPopulationDataSDK';
    ...
    private const SDK_BASE = 'thurgaupopulationdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../thurgaupopulationdata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
