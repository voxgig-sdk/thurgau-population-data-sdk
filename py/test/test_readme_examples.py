# ThurgauPopulationData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ThurgauPopulationDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ThurgauPopulationDataSDK(...) and ThurgauPopulationDataSDK.test(...) become
#      ThurgauPopulationDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "thurgaupopulationdata_sdk"
_SDK_CLASS = "ThurgauPopulationDataSDK"
