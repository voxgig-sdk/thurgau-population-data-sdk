# ThurgauPopulationData Python SDK



The Python SDK for the ThurgauPopulationData API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.PopulationData()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/thurgau-population-data-sdk/releases)) or
...
```
py/
├── thurgaupopulationdata_sdk.py         -- Main SDK module
