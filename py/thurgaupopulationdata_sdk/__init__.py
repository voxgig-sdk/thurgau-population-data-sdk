...
from thurgaupopulationdata_sdk.utility import register

# Load features
from thurgaupopulationdata_sdk.feature.base_feature import ThurgauPopulationDataBaseFeature
from thurgaupopulationdata_sdk.features import _has_feature, _make_feature
...
class ThurgauPopulationDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ThurgauPopulationDataUtility()
        self._utility = utility

        from thurgaupopulationdata_sdk.config import shared_config
    ...
    def get_utility(self):
        return ThurgauPopulationDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ThurgauPopulationDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def PopulationData(self, data=None) -> "PopulationDataEntity":
        ...
        from thurgaupopulationdata_sdk.entity.population_data_entity import PopulationDataEntity
