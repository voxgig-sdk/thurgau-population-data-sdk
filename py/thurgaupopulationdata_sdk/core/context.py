...
from thurgaupopulationdata_sdk.core.helpers import get_ctx_prop, to_map
...
class ThurgauPopulationDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ThurgauPopulationDataControl()
        ...
        if isinstance(sp, ThurgauPopulationDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ThurgauPopulationDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ThurgauPopulationDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ThurgauPopulationDataOperation({})
    ...
    def make_error(self, code, msg):
        return ThurgauPopulationDataError(code, msg, self)
