...
local PopulationDataEntity = {}
PopulationDataEntity.__index = PopulationDataEntity


function PopulationDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PopulationDataEntity)
  self._name = "population_data"
  self._client = client
...
function PopulationDataEntity:get_name()
  return self._name
end


function PopulationDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PopulationDataEntity.new(self._client, opts)
end
...
function PopulationDataEntity:mark_deleted()
  self._deleted = true
end


function PopulationDataEntity:deleted()
  return true == self._deleted
end


function PopulationDataEntity:data_set(args)
  if args ~= nil then
...
function PopulationDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PopulationDataEntity:match_set(args)
  if args ~= nil then
...
function PopulationDataEntity:match_get()
...
function PopulationDataEntity:stream(action, args, callopts)
...
---@param reqmatch PopulationDataLoadMatch
---@param ctrl? table
---@return PopulationData
---@return string? err
function PopulationDataEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PopulationDataListMatch
---@param ctrl? table
---@return PopulationData[]
---@return string? err
function PopulationDataEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function PopulationDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
