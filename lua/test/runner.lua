...
function runner.env_override(m)
  local live = runner.getenv("THURGAU_POPULATION_DATA_TEST_LIVE")
  local override = runner.getenv("THURGAU_POPULATION_DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("THURGAU_POPULATION_DATA_TEST_EXPLAIN")
