...
function runner.env_override(m)
  local live = runner.getenv("THURGAUPOPULATIONDATA_TEST_LIVE")
  local override = runner.getenv("THURGAUPOPULATIONDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("THURGAUPOPULATIONDATA_TEST_EXPLAIN")
