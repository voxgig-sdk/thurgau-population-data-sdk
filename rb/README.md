# ThurgauPopulationData Ruby SDK



The Ruby SDK for the ThurgauPopulationData API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `ThurgauPopulationDataError` (a `StandardError` subclass), so wrap
...
```
rb/
├── ThurgauPopulationData_sdk.rb       -- Main SDK module
...
The main module (`ThurgauPopulationData_sdk`) exports the SDK class
