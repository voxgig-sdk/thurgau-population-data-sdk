...
require_relative 'ThurgauPopulationData_types'
...
class ThurgauPopulationDataSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = ThurgauPopulationDataHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = ThurgauPopulationDataHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, ThurgauPopulationDataFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    ThurgauPopulationDataUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = ThurgauPopulationDataHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = ThurgauPopulationDataHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = ThurgauPopulationDataHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => ThurgauPopulationDataError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue ThurgauPopulationDataError => err
    ...
    if fetched.is_a?(Hash)
      status = ThurgauPopulationDataHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = ThurgauPopulationDataError.new(
        "graphql_error", "ThurgauPopulationDataSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = ThurgauPopulationDataSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
