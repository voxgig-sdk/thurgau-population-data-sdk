...
#      offline in seeded test mode (ThurgauPopulationDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ThurgauPopulationData_sdk.rb")
  SDK_CLASS = "ThurgauPopulationDataSDK"
  ...
  SDK_BASE = "ThurgauPopulationData_sdk"
