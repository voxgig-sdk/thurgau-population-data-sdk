# ThurgauPopulationData SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # ThurgauPopulationDataSDK.new, not ThurgauPopulationDataSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    ThurgauPopulationDataSDK.new(opts)
  end
