...
type Args struct {
	Entity string         `json:"entity" jsonschema:"population_data"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ThurgauPopulationDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "thurgau-population-data_list",
		Description: "List records from ThurgauPopulationData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "thurgau-population-data_load",
		Description: "Load a single record from ThurgauPopulationData. " +
...
func runOp(client *sdk.ThurgauPopulationDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ThurgauPopulationDataSDK, name string) (sdk.ThurgauPopulationDataEntity, error) {
	switch strings.ToLower(name) {
	case "population_data":
		return client.PopulationData(nil), nil
