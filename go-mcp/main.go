// Command ThurgauPopulationData-mcp is an MCP server exposing the ThurgauPopulationData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ThurgauPopulationData_list  — list records of an entity
//	ThurgauPopulationData_load  — load a single record of an entity
//
