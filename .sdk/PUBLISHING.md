...
|---|---|---|
| `ts/` | @voxgig-sdk/thurgau-population-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/thurgau-population-data-sdk \
      --repository voxgig-sdk/thurgau-population-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/thurgau-population-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/thurgau-population-data-sdk --id=<id>` removes it.
