...
// ThurgauPopulationData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ThurgauPopulationDataOmni::makeStructRunner(
    ...
    {
        return ThurgauPopulationDataOmni::objmodel(ThurgauPopulationDataOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return ThurgauPopulationDataOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return ThurgauPopulationDataOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ThurgauPopulationDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(ThurgauPopulationDataOmni::structfix($val, Struct::undef()))) {
