...
// ThurgauPopulationData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ThurgauPopulationDataMakeRequest
{
    public static function call(ThurgauPopulationDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ThurgauPopulationDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ThurgauPopulationDataResponse($fetched);
        } else {
