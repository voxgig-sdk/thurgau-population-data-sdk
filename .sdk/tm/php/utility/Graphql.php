...
// ThurgauPopulationData SDK utility: graphql
//
...
class ThurgauPopulationDataGraphql
{
    ...
    // equivalent.
    public static function body(ThurgauPopulationDataContext $ctx): mixed
    {
    ...
    public static function errors(ThurgauPopulationDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
