...
// ThurgauPopulationData SDK proxy feature
...
class ThurgauPopulationDataProxyFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    public function init(ThurgauPopulationDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ThurgauPopulationDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
