...
// ThurgauPopulationData SDK timeout feature
...
class ThurgauPopulationDataTimeoutFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    private function _with_timeout(ThurgauPopulationDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ThurgauPopulationDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
