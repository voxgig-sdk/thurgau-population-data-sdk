...
// ThurgauPopulationData SDK ratelimit feature
...
class ThurgauPopulationDataRatelimitFeature extends ThurgauPopulationDataBaseFeature
{
    ...
    private function _acquire(ThurgauPopulationDataContext $ctx): void
    {
    ...
    private function _track(ThurgauPopulationDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
